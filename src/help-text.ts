...
export function printHelp(version: string): void {
  ...
  process.stdout.write('  --web [path]             Launch browser-based web UI\n')
  process.stdout.write('  --host <addr>            Bind address for web mode (default: 127.0.0.1)\n')
  process.stdout.write('  --port <number>          Port for web mode (default: auto)\n')
  process.stdout.write('  --allowed-origins <list> Comma-separated allowed origins for web mode\n')
