...
export function registerDbTools(pi: ExtensionAPI): void {
  ...
  const reassessRoadmapTool = {
    ...
    promptGuidelines: [
      ...
      "sliceChanges.modified and sliceChanges.added items: sliceId, title, risk (optional), depends (optional), demo (optional), sequence (optional integer).",
    ],
    parameters: Type.Object({
      milestoneId: Type.String({ description: "Milestone ID (e.g. M001)" }),
      ...
      sliceChanges: Type.Object({
        modified: Type.Array(
          Type.Object({
            ...
            sequence: Type.Optional(Type.Number({ description: "Updated sequence ordering" })),
          }),
        ...
        added: Type.Array(
          Type.Object({
            ...
            sequence: Type.Optional(Type.Number({ description: "Sequence ordering" })),
          }),
