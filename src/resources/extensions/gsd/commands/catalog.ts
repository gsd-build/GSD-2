...
export const TOP_LEVEL_SUBCOMMANDS: readonly GsdCommandDefinition[] = [
  ...
  { cmd: "hooks", desc: "Show all hooks (GSD workflow + community) with status and stats" },
...
const NESTED_COMPLETIONS: CompletionMap = {
  ...
  hooks: [
    { cmd: "list", desc: "List all hooks with status" },
    { cmd: "enable", desc: "Enable a community hook" },
    { cmd: "disable", desc: "Disable a community hook" },
    { cmd: "info", desc: "Show hook details and config" },
    { cmd: "stats", desc: "Show session statistics" },
    { cmd: "reset-stats", desc: "Reset session statistics" },
    { cmd: "enable-all", desc: "Enable all community hooks" },
    { cmd: "disable-all", desc: "Disable all community hooks" },
  ],
  keys: [
