# M002-zbyhgi: Browser Tools Performance & Intelligence — Context
...
- `src/resources/extensions/browser-tools/BROWSER-TOOLS-V2-PROPOSAL.md` — Design proposal; many items already implemented (assertions, batch, diff, timeline, pages, frames, traces). M002-zbyhgi covers remaining items: form intelligence, intent ranking, semantic actions, plus performance work not in V2 proposal.
