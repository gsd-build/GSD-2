...
- S01 task summaries (`.gsd/milestones/M001-h5msp6/slices/S01/tasks/T01-SUMMARY.md`, `T02-SUMMARY.md`) — authoritative source for `getManifestStatus` contract
- S02 task summaries (`.gsd/milestones/M001-h5msp6/slices/S02/tasks/T01-SUMMARY.md`, `T02-SUMMARY.md`, `T03-SUMMARY.md`) — authoritative source for `collectSecretsFromManifest`, `showSecretsSummary`, guidance rendering
...
- `gsd/M001-h5msp6/S02` branch — verified exports of `collectSecretsFromManifest`, `showSecretsSummary`, `getManifestStatus`
