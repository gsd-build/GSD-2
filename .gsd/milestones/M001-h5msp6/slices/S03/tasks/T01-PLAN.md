...
1. Merge `gsd/M001-h5msp6/S02` into the current `gsd/M001-h5msp6/S03` branch. Resolve any conflicts (expected: none or trivial).
...
- `gsd/M001-h5msp6/S02` branch — contains all S01+S02 code including `getManifestStatus`, `collectSecretsFromManifest`, manifest parser/formatter, collection TUI
