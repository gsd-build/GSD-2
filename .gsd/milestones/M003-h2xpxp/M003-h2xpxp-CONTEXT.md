# M003-h2xpxp: Worktree-Isolated Git Architecture
...
- `git log milestone/M003-h2xpxp` shows full commit history with `--no-ff` merge boundaries per slice
...
- **Worktree naming convention for auto-worktrees** — should auto-worktrees use the milestone ID as the name (`.gsd/worktrees/M003-h2xpxp/`) or a prefixed name (`.gsd/worktrees/auto-M003-h2xpxp/`)? Current thinking: bare milestone ID is cleaner and the branch convention (`milestone/M003-h2xpxp` vs `worktree/<name>`) disambiguates from manual worktrees.
