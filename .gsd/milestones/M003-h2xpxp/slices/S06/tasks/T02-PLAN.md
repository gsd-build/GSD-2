...
3. Implement test cases:
   - Orphaned worktree: create worktree with `milestone/M001-h5msp6` branch, mark M001-h5msp6 complete in roadmap → doctor detects `orphaned_auto_worktree`, fix removes it
   - Stale branch: create `milestone/M001-h5msp6` branch (no worktree), mark M001-h5msp6 complete → doctor detects `stale_milestone_branch`, fix deletes branch
