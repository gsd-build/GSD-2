...
2. Verify the "lifecycle" test group passes:
   - `createAutoWorktree` creates `.gsd/worktrees/M003-h2xpxp/` directory
   - Git branch in worktree is `milestone/M003-h2xpxp`
...
1. In the lifecycle test, `.gsd/milestones/M003-h2xpxp/` is committed before worktree creation
2. After `createAutoWorktree`, check that `.gsd/milestones/M003-h2xpxp/` exists in the worktree
...
1. Create auto-worktree with `milestone/M003-h2xpxp` branch
