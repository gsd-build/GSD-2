...
1. Create a temp repo with a `milestone/M001-h5msp6` branch
2. Create a slice branch with 3 commits modifying different files
3. Call `mergeSliceToMilestone(basePath, "M001-h5msp6", "S01", "Test slice")`
4. Run `git log --oneline --graph milestone/M001-h5msp6`
...
3. Call `mergeSliceToMilestone(basePath, "M001-h5msp6", "S02", "Second slice")`
4. Run `git log --oneline --graph milestone/M001-h5msp6`
...
3. **Expected:** The slice branch (e.g. `gsd/M001-h5msp6/S01`) no longer exists.
