...
- **Dirty worktree at merge time** — the complete-milestone unit writes `M003-h2xpxp-SUMMARY.md` and other files. These must be committed on the milestone branch before the squash-merge. Auto-commit in the worktree before chdir-ing out.
