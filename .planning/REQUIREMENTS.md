...
- [x] **DIST-04**: Landing page (single HTML, GitHub Pages or Vercel) — GSD branding, headline, download buttons linking to latest GitHub Release, "Powered by GSD 2", responsive
